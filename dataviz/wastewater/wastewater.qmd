...
description: |
  Which U.S. wastewater treatment plants might pose an environmental concern?
date: 09-24-2022
...
The visualization uses TidyTuesday's **Wastewater Plants** dataset (Sep 2022), whose data context and information can be accessed at <a href="https://github.com/rfordatascience/tidytuesday/tree/master/data/2022/2022-09-20" target="_blank" rel="noopener">this link</a> 
...
South Central region (especially around Northwest Texas region) and California have a higher concentration of wastewater treatment plants with a dilution factor below regulatory threshold. 
